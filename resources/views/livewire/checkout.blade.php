<div class="container">
    ...
    <div class="row mt-4">
        <div class="col">
            ...
            <hr>
            <p>Untuk pembayaran silahkan dapat transfer di rekening di bawah ini sebesar : <strong>Rp. {{ number_format($total_harga) }}</strong></p>
            <div class="media">
        ...
        <div class="col">
            ...
            <form wire:submit.prevent="checkout">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('no_hp') is-invalid @enderror" wire:model="no_hp" value="{{ old('no_hp') }}" autocomplete="name" autofocus>
