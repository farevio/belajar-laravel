                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @foreach ($pesanan_details as $pesanan_detail)
                                    <img src="{{ url('assets/all_product/') }}/{{$pesanan_detail->product->gambar}}" class="img-fluid" width="50">
    ...
    <div class="row">
        <div class="col">
            <div class="card shadow">
                <div class="card-body">
                    <p>Untuk pembayaran silahkan dapat transfer di rekening di bawah ini:
                    <div class="media">
